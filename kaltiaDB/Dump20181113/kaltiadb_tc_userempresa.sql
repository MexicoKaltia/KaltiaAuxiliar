...
CREATE TABLE `tc_userempresa` (
  `idUserEmpresa` varchar(12) NOT NULL,
...
INSERT INTO `tc_userempresa` VALUES ('broneauser','bronea','nombre','apellidos','email','telefono','user','pass','mensaje');
...
-- Dump completed on 2018-11-13 17:46:50
