...
CREATE TABLE `tw_statusempresa` (
  ...
  `statusEmpresaModoPago` varchar(45) DEFAULT NULL,
  `statusEmpresaVarios` varchar(45) DEFAULT NULL,
  `statusEmpresaFactura` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2018-05-23 17:13:16
