...
<body>
    ...
    <div class="sequence">
      ...
      <div class="seq-preloader">
        ...
        <nav>
          ...
          <ul>
            <li><a href="#1"><i class="fa fa-home"></i> <em>Bienveni222do</em></a></li>
            <li><a href="#2"><i class="fa fa-user"></i> <em>Conocenos</em></a></li>
            <li><a href="#3"><i class="fa fa-pencil"></i> <em>Proyectos</em></a></li>
            <li><a href="#4"><i class="fa fa-image"></i> <em>Consultoria</em></a></li>
          ...
          <div class="slide" id="1">
            <div class="content first-content">
              <div class="container-fluid">
                  ...
                  <div class="col-md-9">
                      <h2>Bienvenido a KaltiaContenidos</h2>
                      <p>Hay que enfocar los esfuerzos en nuestro proyecto, en nuestro futuro,  
						<strong>
							<a rel="nofollow" href="http://www.kaltiaservicios.tech">ANIMO</a>
						</strong>
						tu tiempo cada ves es mas valioso, por q te queda MENOS !!! 
						<em>Emprende,</em>
						Sigamos trabajando, pero cambiemos de patron<em>ahora somos nosotros,</em>
						falta DECISION.
					</p>					  
                      <div class="main-btn"><a href="#2">Consulta las BASES</a></div>
                      <div class="fb-btn"><a rel="nofollow" href="http://kaltiaservicios.site/baile">un Ejemplo</a></div>
                  </div>
              </div>
            </div>
          </div>
	...
	-->
        ...
        <div class="footer">
          <div class="content">
              <p>Copyright &copy; 2020 Mexico KALTIA. : <a rel="nofollow" href="http://kaltiaservicios.tech">KALTIA SERVICIOS</a></p>
          </div>
        </div>
