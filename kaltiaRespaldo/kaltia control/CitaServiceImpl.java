...
////			logger.info("descripcion"+descripcionCita);
//			
...
//			citaEntityUpdate(citaEntity);
//			
//			resultVO.setCodigo(0);
//			resultVO.setMensaje("Cita pendiente de confirmacion");
//			/*
//			 * Aqui puedo guardar en formato JSON con la clase CitaEmpresaServiceImpl  <--  tiene el userEmpresa y descripcionCita
//			 */
//			
//		}catch(Exception e) {
//			e.printStackTrace();
...
//		return resultVO;
	...
	@Override
	public ResultVO citaEntityCreate(String action, String horario) {
		
//		CitaEntity  citaEntity = new CitaEntity();
//		citaEntity.setIdAction(action);
//		citaEntity.setCondicionesCita(horario);
//		citaEntity.setEneroCita("{}");
//		citaEntity.setFebreroCita("{}");
//		citaEntity.setMarzoCita("{}");
//		citaEntity.setAbrilCita("{}");
//		citaEntity.setMayoCita("{}");
//		citaEntity.setJunioCita("{}");
//		citaEntity.setJulioCita("{}");
//		citaEntity.setAgostoCita("{}");
//		citaEntity.setSeptiembreCita("{}");
//		citaEntity.setOctubreCita("{}");
//		citaEntity.setNoviembreCita("{}");
//		citaEntity.setDiciembreCita("{}");
...
//	private void citaEntityUpdate(CitaEntity citaEntity) {
//		try {
//			citaDAO.save(citaEntity);
//			}catch(Exception e) {
